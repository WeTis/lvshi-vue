  ...
  <div class="dashboard-container">
    ...
    >
      ...
      <el-table-column align="center" prop="created_at" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="delectFn(scope.row)">删除</el-button>
    ...
    <el-dialog title="新增/修改广告" :visible.sync="dialogFormVisible">

      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
        <el-form-item label="广告标题：" prop="title">
          <el-input v-model="ruleForm.title" />
        </el-form-item>
        <!-- <el-form-item label="广告概述：" prop="content">
          <el-input v-model="ruleForm.content" type="textarea" />
        </el-form-item>
        
        <el-form-item label="广告作者：" prop="createUser">
          <el-input v-model="ruleForm.createUser" />
        </el-form-item> -->
        <el-form-item label="广告链接：" prop="addressUrl">
          <el-input v-model="ruleForm.addressUrl" placeholder="当点击广告跳转时需要输入微信公众号文章链接"/>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        content: [
          { required: true, message: '请输入广告概述', trigger: 'blur' },
          { min: 3, max: 100, message: '长度在 3 到 100 个字符', trigger: 'blur' }
        ],
        // addressUrl: [{ required: true, message: '请输入广告链接', trigger: 'blur' }],
        createUser: [{ required: true, message: '请输入广告作者', trigger: 'blur' }],
